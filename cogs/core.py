...
CATEGORIES = [
    ("Moderation", "🛡️", {"Moderation", "AutoMod", "AdvancedSafe"}),
    ("Levels", "⭐", {"Leveling", "AdvancedSafe"}),
    ("Tickets", "🎫", {"Tickets", "TicketPlus", "AdvancedSafe"}),
    ("Roles", "🏷️", {"Roles"}),
    ("Economy", "🪙", {"Currency", "AdvancedSafe"}),
    ("Music", "🎵", {"Music"}),
    ("Fun", "🎉", {"Fun", "AdvancedSafe"}),
    ("Games", "🎮", {"Games"}),
    ("Server", "🖥️", {"ServerInfo", "MemberStats", "Welcome", "Logging", "AdvancedSafe"}),
    ("Giveaways", "🎁", {"Giveaways", "GiveawayPlus", "AdvancedSafe"}),
    ("Applications", "📝", {"ApplicationCog"}),
    ("Custom Commands", "⚙️", {"CustomCommands"}),
    ("Configuration", "🔧", {"Admin", "Panels", "Embeds"}),
    ("Temp Voice", "🔊", {"TempVoice"}),
    ("Core", "💠", {"Core", "AdvancedSafe"}),
]
...
class HelpView(discord.ui.View):
    ...
    def category_embed(self):
        ...
        embed.set_footer(text=f"Page {self.page+1}/{pages} • LightCore"); return embed
...
class Core(commands.Cog):
    ...
    async def about(self,ctx):
        embed=discord.Embed(title="💠 LightCore",description="All-in-one Discord moderation, community, leveling, tickets, music and utility bot.",color=discord.Color.blurple()); links=[]
