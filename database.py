...
def init_db():
    with connect() as db:
        ...
        CREATE TABLE IF NOT EXISTS guild_settings (
            ...
            log_channel INTEGER, welcome_channel INTEGER, goodbye_channel INTEGER,
            welcome_message TEXT, goodbye_message TEXT, muted_role INTEGER,
            ticket_category INTEGER, ticket_log_channel INTEGER, ticket_config TEXT,
            level_enabled INTEGER NOT NULL DEFAULT 1, currency_enabled INTEGER NOT NULL DEFAULT 1,
            automod_enabled INTEGER NOT NULL DEFAULT 0, level_xp_min INTEGER NOT NULL DEFAULT 15,
            level_xp_max INTEGER NOT NULL DEFAULT 25, level_cooldown INTEGER NOT NULL DEFAULT 60,
            level_message TEXT DEFAULT 'GG {user}! You reached level {level}.',
            memberstats_enabled INTEGER NOT NULL DEFAULT 1, memberstats_channel INTEGER,
            application_review_channel INTEGER, tempvoice_category INTEGER,
            tempvoice_join_channel INTEGER, tempvoice_panel_channel INTEGER
        );
        ...
        -- TicketV2-style rebuilt schema. These tables are independent of the retired ticket implementation.
        CREATE TABLE IF NOT EXISTS ticket_systems (
            ...
            description TEXT NOT NULL DEFAULT 'Choose a ticket type below to contact our support team.',
        ...
        CREATE TABLE IF NOT EXISTS ticket_types (
            ...
            description TEXT NOT NULL DEFAULT 'Open a support ticket.',
        ...
        CREATE TABLE IF NOT EXISTS ticket_transcript_v2 (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            ticket_id INTEGER NOT NULL,
            guild_id INTEGER NOT NULL,
        ...
        -- Application system rebuilt independently from the retired implementation.
        CREATE TABLE IF NOT EXISTS app_forms_v2 (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            guild_id INTEGER NOT NULL,
            name TEXT NOT NULL,
            description TEXT NOT NULL DEFAULT 'Complete the form below.',
            review_channel_id INTEGER,
            cooldown_minutes INTEGER NOT NULL DEFAULT 1440,
            reapply_mode TEXT NOT NULL DEFAULT 'after_denial',
            enabled INTEGER NOT NULL DEFAULT 1,
            created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
        );
        CREATE TABLE IF NOT EXISTS app_questions_v2 (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        CREATE TABLE IF NOT EXISTS app_submissions_v2 (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            form_id INTEGER NOT NULL,
            guild_id INTEGER NOT NULL,
            user_id INTEGER NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS app_panels_v2 (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            form_id INTEGER NOT NULL,
            guild_id INTEGER NOT NULL,
            channel_id INTEGER NOT NULL,
        ...
        -- Giveaway system rebuilt independently from the retired claim implementation.
        CREATE TABLE IF NOT EXISTS giveaway_v2 (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            guild_id INTEGER NOT NULL,
            channel_id INTEGER NOT NULL,
            message_id INTEGER NOT NULL UNIQUE,
        ...
        CREATE TABLE IF NOT EXISTS giveaway_bonus_roles_v2 (
            giveaway_id INTEGER NOT NULL,
...
_ALLOWED_SETTINGS = {
    'prefix', 'log_channel', 'welcome_channel', 'goodbye_channel', 'welcome_message', 'goodbye_message',
    'muted_role', 'ticket_category', 'ticket_log_channel', 'ticket_config', 'level_enabled', 'currency_enabled',
    'automod_enabled', 'level_xp_min', 'level_xp_max', 'level_cooldown', 'level_message', 'memberstats_enabled',
    'memberstats_channel', 'application_review_channel', 'tempvoice_category', 'tempvoice_join_channel',
